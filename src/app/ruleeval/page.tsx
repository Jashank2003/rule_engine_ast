...
import VisualRule from '../components/VisualRule'; 
...
const RuleManager = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-[98vw] max-w-2xl mx-auto my-6">
        <h1 className="text-3xl font-bold text-center text-white mb-6">Rule Evaluation</h1>
